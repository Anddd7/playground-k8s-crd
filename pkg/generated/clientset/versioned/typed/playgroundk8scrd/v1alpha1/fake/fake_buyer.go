...
type FakeBuyers struct {
	Fake *FakePlaygroundk8scrdV1alpha1
	ns   string
}

var buyersResource = schema.GroupVersionResource{Group: "playgroundk8scrd.anddd7.github.com", Version: "v1alpha1", Resource: "buyers"}

var buyersKind = schema.GroupVersionKind{Group: "playgroundk8scrd.anddd7.github.com", Version: "v1alpha1", Kind: "Buyer"}
...
func (c *FakeBuyers) Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(buyersResource, c.ns, opts))

	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Playgroundk8scrdV1alpha1().Buyers(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Playgroundk8scrdV1alpha1().Buyers(namespace).Watch(context.TODO(), options)
			},
		},
		&playgroundk8scrdv1alpha1.Buyer{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *buyerInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&playgroundk8scrdv1alpha1.Buyer{}, f.defaultInformer)
}
